...
const INITIAL_VISIBLE_COLUMNS: Array<keyof QBittorrentTorrent> = ['priority', 'name', 'progress', 'added_on', 'dlspeed', 'upspeed', 'total_size', 'state', 'tracker']
...
export function useVisibleColumns(): [Selection, (value: Selection) => void] {
	...
	const setVisibleColumnsSelection = useCallback(
		(value: Selection) => {

					...
					{(onClose) => (
						<>
							...
							<ModalBody>
								{withFiles ? (
									<p>
										Are you sure you want to remove this torrent and all its associated files? This action is not
										reversible.
									</p>
								) : (
									<p>Are you sure you want to remove this torrent? This action is not reversible.</p>
								)}
							</ModalBody>
							<ModalFooter>

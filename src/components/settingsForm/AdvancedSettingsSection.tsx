...
>) => {
	...
	const [networkInterfacesList, setNetworkInterfacesList] = useState<Array<{ name: string, value: string }>>(current_network_interface ? [{ name: current_network_interface, value: current_network_interface }] : [])
	...
	const [selectedNetworkInterface, setSelectedNetworkInterface] = useState<Selection>(current_network_interface !== undefined ? new Set([current_network_interface]) : new Set())
	...
	return (
		<>
			...
			/>
			<Checkbox name="recheck_completed_torrents" defaultSelected={recheck_completed_torrents}>Recheck torrents on completion</Checkbox>
			<Input
				name="app_instance_name"
				label="Customize application instance name"
				defaultValue={app_instance_name}
			/>
			<Input
			...
			/>
			<Checkbox name="resolve_peer_countries" defaultSelected={resolve_peer_countries}>Resolve peer countries</Checkbox>
			<Checkbox name="reannounce_when_address_changed" defaultSelected={reannounce_when_address_changed}>Reannounce to all trackers when IP or port changed</Checkbox>
			<Checkbox name="enable_embedded_tracker" isSelected={embeddedTrackerEnabledState} onValueChange={setEmbeddedTrackedEnabledState}>Enable embedded tracker</Checkbox>
			<Input
				...
				type="number"
			/>
			<Checkbox name="embedded_tracker_port_forwarding" defaultSelected={embedded_tracker_port_forwarding}>Enable port forwarding for embedded tracker</Checkbox>
			<Checkbox name="ignore_ssl_errors" defaultSelected={ignore_ssl_errors}>Ignore SSL errors</Checkbox>
			<Input
			...
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Bdecoding.html#bdecode()" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
			...
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#aio_threads" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#hashing_threads" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
				name="file_pool_size"
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#file_pool_size" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
			...
			<Select
				...
				endContent={<Link href="https://www.libtorrent.org/single-page-ref.html#default-disk-io-constructor" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			>
			...
			<Select
				...
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#disk_io_read_mode" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			>
			...
			<div className="flex gap-1">
				<Checkbox name="enable_piece_extent_affinity" defaultSelected={enable_piece_extent_affinity}>Use piece extent affinity</Checkbox>
				<Link href="https://libtorrent.org/single-page-ref.html#piece_extent_affinity" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="enable_upload_suggestions" defaultSelected={enable_upload_suggestions}>Send upload piece suggestions</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#suggest_mode" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<Input
			...
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#outgoing_port" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
				name="peer_tos"
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#peer_dscp" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Select
				...
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#mixed_mode_algorithm" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			>
				<SelectItem key={QBittorrentPreferencesUTPTCPMixedMode.PREFER_TCP.toString()}>Prefer TCP</SelectItem>
				<SelectItem key={QBittorrentPreferencesUTPTCPMixedMode.PEER_PROPORTIONAL.toString()}>Peer proportional (throttles TCP)</SelectItem>
			</Select>
			<div className="flex gap-1">
				<Checkbox name="idn_support_enabled" defaultSelected={idn_support_enabled}>Support internationalized domain name (IDN)</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#allow_idna" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="enable_multi_connections_from_same_ip" defaultSelected={enable_multi_connections_from_same_ip}>Allow multiple connections from the same IP address</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#allow_multiple_connections_per_ip" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="validate_https_tracker_certificate" defaultSelected={validate_https_tracker_certificate}>Validate HTTPS tracker certificate</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#validate_https_trackers" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="ssrf_mitigation" defaultSelected={ssrf_mitigation}>Server-side request forgery (SSRF) mitigation</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#ssrf_mitigation" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="block_peers_on_privileged_ports" defaultSelected={block_peers_on_privileged_ports}>Disallow connection to peers on privileged ports</Checkbox>
				<Link href="https://libtorrent.org/single-page-ref.html#no_connect_privileged_ports" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<Select
				...
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#choking_algorithm" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			>
			...
			<Select
				...
				label="Upload slots behavior"
				defaultSelectedKeys={upload_choking_algorithm !== undefined ? new Set([upload_choking_algorithm.toString()]) : new Set()}
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#seed_choking_algorithm" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			>
			...
			<div className="flex gap-1">
				<Checkbox name="announce_to_all_trackers" defaultSelected={announce_to_all_trackers}>Always announce to all trackers in a tier</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#announce_to_all_trackers" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<div className="flex gap-1">
				<Checkbox name="announce_to_all_tiers" defaultSelected={announce_to_all_tiers}>Always announce to all tiers</Checkbox>
				<Link href="https://www.libtorrent.org/reference-Settings.html#announce_to_all_tiers" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
			</div>
			<Input
				name="announce_ip"
				label="IP address reported to trackers (requires restart)"
				defaultValue={announce_ip}
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#announce_ip" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#max_concurrent_http_announces" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
				...
				endContent={(
					<>
						...
						<Link href="https://www.libtorrent.org/reference-Settings.html#stop_tracker_timeout" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
					</>
				)}
			/>
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#peer_turnover" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>
			<Input
			...
			<Input
				...
				endContent={(
					<>
						<p className="text-nowrap">seconds</p>
						<Link href="https://www.libtorrent.org/reference-Settings.html#peer_turnove" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>
					</>
				)}
			/>
			<Input
				...
				type="number"
				endContent={<Link href="https://www.libtorrent.org/reference-Settings.html#max_out_request_queue" target="_blank" referrerPolicy="no-referrer"><IconExternalLink /></Link>}
			/>

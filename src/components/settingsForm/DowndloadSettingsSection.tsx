	...
	>) => {
		...
		return (
			<>
				...
				<Checkbox name="add_to_top_of_queue" defaultSelected={add_to_top_of_queue}>
					Add torrent to top of queue by default
				</Checkbox>
				<Checkbox name="add_stopped_enabled" defaultSelected={add_stopped_enabled}>
				...
				<Checkbox name="merge_trackers" defaultSelected={merge_trackers}>
					Merge trackers when duplicates are added
				</Checkbox>
				<Checkbox name="auto_delete_mode" defaultSelected={auto_delete_mode === 1}>
					Delete .torrent files afterward
				</Checkbox>
				<Divider className="my-2" />

				<Checkbox name="preallocate_all" defaultSelected={preallocate_all}>
					Pre-allocate disk space for all files
				</Checkbox>
				<Checkbox name="incomplete_files_ext" defaultSelected={incomplete_files_ext}>
					Append .!qB extension to incomplete files
				</Checkbox>
				<Checkbox name="use_unwanted_folder" defaultSelected={use_unwanted_folder}>
					Keep unselected files in ".unwanted" folder
				</Checkbox>
				<Divider className="my-2" />

				<Checkbox name="auto_tmm_enabled" defaultSelected={auto_tmm_enabled}>
					Manage torrents automatically by default
				</Checkbox>
				<Checkbox name="torrent_changed_tmm_enabled" defaultSelected={torrent_changed_tmm_enabled}>
					When torrent category changes, relocate files
				</Checkbox>
				<Checkbox name="save_path_changed_tmm_enabled" defaultSelected={save_path_changed_tmm_enabled}>
					When default save path changes, relocate files
				</Checkbox>
				<Checkbox name="category_changed_tmm_enabled" defaultSelected={category_changed_tmm_enabled}>
					When category save path changes, relocate files
				</Checkbox>
				<Checkbox name="use_subcategories" defaultSelected={use_subcategories}>
					Use subcategories
				</Checkbox>
				<Checkbox name="use_category_paths_in_manual_mode" defaultSelected={use_category_paths_in_manual_mode}>
					Use category paths in manual mode
				</Checkbox>
				<Checkbox name="temp_path_enabled" isSelected={tempPathEnabledState} onValueChange={setTempPathEnabledState}>
					Keep incomplete files in a different folder
				</Checkbox>
				...
				<Checkbox
					name="exclude_file_names_enabled"
					isSelected={excludeFileNameEnabledState}
					onValueChange={setExcludeFileNameEnabledSate}
				>
					Exclude file names
				</Checkbox>
				<Textarea
					name="exclude_file_names"
					label="Excluded file names"
					isDisabled={!excludeFileNameEnabledState}
					defaultValue={exclude_file_names}
				/>
				<Divider className="my-2" />

				<Checkbox
					name="mail_notification_enabled"
					isSelected={mailNotificationEnabledState}
					onValueChange={setMailNotificationEnabledState}
				>
					Send an email notification upon download completion
				</Checkbox>
				<Input
					name="mail_notification_sender"
					isDisabled={!mailNotificationEnabledState}
					defaultValue={mail_notification_sender}
					label="Email sender"
				/>
				<Input
					name="mail_notification_email"
					isDisabled={!mailNotificationEnabledState}
					defaultValue={mail_notification_email}
					label="Email recipient"
				/>
				<Input
					name="mail_notification_smtp"
					isDisabled={!mailNotificationEnabledState}
					defaultValue={mail_notification_smtp}
					label="SMTP server address"
				/>
				<Checkbox
					name="mail_notification_ssl_enabled"
					isDisabled={!mailNotificationEnabledState}
					defaultSelected={mail_notification_ssl_enabled}
				>
				...
				<Checkbox
					...
					isDisabled={!mailNotificationEnabledState}
					isSelected={mailNotificationAuthEnabledState}
					onValueChange={setMailNotificationAuthEnabledState}
				>
					This server requires authentication
				</Checkbox>
				<Input
					name="mail_notification_username"
					isDisabled={!mailNotificationEnabledState || !mailNotificationAuthEnabledState}
					defaultValue={mail_notification_username}
					label="Username"
				/>
				<Input
					name="mail_notification_password"
					isDisabled={!mailNotificationEnabledState || !mailNotificationAuthEnabledState}
					defaultValue={mail_notification_password}
					type="password"
					label="Password"
				/>
				<Button
				...
				<Checkbox
					...
					isSelected={autorunAddedEnabledState}
					onValueChange={setAutorunAddedEnabledState}
				>
					Run external program on torrent added
				</Checkbox>
				<Input
					name="autorun_on_torrent_added_program"
					isDisabled={!autorunAddedEnabledState}
					defaultValue={autorun_on_torrent_added_program}
					label="Command line to run on torrent added"
				/>
				<Checkbox name="autorun_enabled" isSelected={autorunFinishedEnabledState} onValueChange={setAutorunFinishedEnabledState}>
					Run external program on torrent finished
				</Checkbox>
				<Input
					name="autorun_program"
					isDisabled={!autorunFinishedEnabledState}
					defaultValue={autorun_program}
					label="Command line to run on torrent finished"
				/>
				<Alert
					hideIcon

import {
	...
	QBittorrentPreferencesEncryptionMode,
	QBittorrentPreferencesMaxRatioAct,
...
export const BittorrentSettingsSection = memo(
	...
	>) => {
		...
		return (
			<>
				<Checkbox name="dht" isSelected={dhtEnabledState} onValueChange={setDHTEnabledState}>
				...
				/>
				<Checkbox name="pex" defaultSelected={pex}>
					Enable Peer Exchange (PeX) to find more peers
				</Checkbox>
				<Checkbox name="lsd" defaultSelected={lsd}>
					Enable Local Peer Discovery to find more peers
				</Checkbox>
				<Select
					name="encryption"
					label="Encryption mode"
					defaultSelectedKeys={encryption !== undefined ? new Set([encryption.toString()]) : new Set()}
				>
				...
				<div className="flex gap-1">
					<Checkbox name="anonymous_mode" defaultSelected={anonymous_mode}>
				...
				<Checkbox name="queueing_enabled" isSelected={torrentQueuingEnabledState} onValueChange={setTorrentQueuingEnabledState}>
				...
				<Checkbox
					...
					isSelected={dontCountSlowTorrentsEnabledState}
					onValueChange={setDontCountSlowTorrentsEnabledState}
				>
					Do not count slow torrents in torrent queueing
				</Checkbox>
				<Input
				...
				<Select
					...
					defaultSelectedKeys={max_ratio_act !== undefined ? new Set([max_ratio_act.toString()]) : new Set()}
				>
					...
					<SelectItem key={QBittorrentPreferencesMaxRatioAct.REMOVE_TORRENT_AND_FILES.toString()}>
				...
				<Checkbox name="max_ratio_enabled" isSelected={maxRatioEnabledState} onValueChange={setMaxRatioEnabledState}>
					Execute seeding action when ratio reaches
				</Checkbox>
				<Input
					name="max_ratio"
				...
				<Checkbox
					...
					isSelected={maxSeedingTimeEnabledState}
					onValueChange={setMaxSeedingTimeEnabledState}
				>
					Execute seeding action when seeding time reaches
				</Checkbox>
				<Input
				...
				<Checkbox
					...
					isSelected={maxInactiveSeedingTimeEnabledState}
					onValueChange={setMaxInactiveSeedingTimeEnabledState}
				>
					Execute seeding action when inactive seeding time reaches
				</Checkbox>
				<Input
				...
				<Checkbox name="add_trackers_enabled" isSelected={addTrackersEnabledState} onValueChange={setAddTrackersEnabledState}>
					Automatically append these trackers to new downloads
				</Checkbox>
				<Textarea
					name="add_trackers"
					label="Trackers URLs (1 per line)"
					isDisabled={!addTrackersEnabledState}
					defaultValue={add_trackers}
				/>
			</>
		)
	}

...
export const RSSSettingsSection = memo(
	...
	>) => {
		...
		return (
			<>
				<Checkbox name="rss_processing_enabled" isSelected={rssProcessingEnabledState} onValueChange={setRSSProcessingEnabledState}>
				...
				<Checkbox name="rss_auto_downloading_enabled" defaultSelected={rss_auto_downloading_enabled}>
					Enable auto downloading of RSS torrents
				</Checkbox>
				<Divider className="my-2" />

				<Checkbox name="rss_download_repack_proper_episodes" defaultSelected={rss_download_repack_proper_episodes}>

	...
	[
		{
			label: 'Allocating',
			value: 'allocating',
			icon: <QBittorrentStateIcon state="allocating" />,
		},
		{
			label: 'Checking Resume Data',
			value: 'checkingResumeData',
			icon: <QBittorrentStateIcon state="checkingResumeData" />,
		},
		...
		{ label: 'Metadata', value: 'metaDL', icon: <QBittorrentStateIcon state="metaDL" /> },
		{
			label: 'Missing Files',
			value: 'missingFiles',
			icon: <QBittorrentStateIcon state="missingFiles" />,
		},
	...
	[
		{
			label: 'Downloading',
			value: 'downloading',
			icon: <QBittorrentStateIcon state="downloading" />,
		},
		...
		{ label: 'Paused', value: 'pausedDL', icon: <QBittorrentStateIcon state="pausedDL" /> },
		{
			label: 'Checking',
			value: 'checkingDL',
			icon: <QBittorrentStateIcon state="checkingDL" />,
		},
	...
	[
		{
			label: 'Uploading',
			value: 'uploading',
			icon: <QBittorrentStateIcon state="uploading" />,
		},
		...
		{ label: 'Paused', value: 'pausedUP', icon: <QBittorrentStateIcon state="pausedUP" /> },
		{
			label: 'Checking',
			value: 'checkingUP',
			icon: <QBittorrentStateIcon state="checkingUP" />,
		},
